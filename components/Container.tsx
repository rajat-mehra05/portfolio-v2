...
export default function Container(props) {
  ...
  const meta = {
    ...
    description: `Software Engineer with expertise in TypeScript, React, and Next.js. I build scalable web applications and AI-powered solutions.`,
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://rajatmehra.dev${router.asPath}`}
        />
        <link rel="canonical" href={`https://rajatmehra.dev${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Rajat Mehra" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@_rajat_mehra_" />
