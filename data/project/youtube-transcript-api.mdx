...
description: 'A JavaScript/TypeScript library for extracting YouTube transcripts with 450+ weekly downloads on npm. No API keys, no Selenium. Supports multiple formats and languages.'
...
I also noticed the gap on npm - there wasn't a good JS/TS library for this. So I published it as a standalone package. It now has <Highlight color="cyan">450+ weekly downloads</Highlight> on npm.
