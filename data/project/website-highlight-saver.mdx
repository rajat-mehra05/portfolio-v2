...
I wanted something that lived inside the browser itself. Highlight text, click save, done. And if the passage was long, let AI summarize it so I could scan it later. This was also my way into Chrome extension development - I vibe coded the initial version but followed standard code practices throughout.
