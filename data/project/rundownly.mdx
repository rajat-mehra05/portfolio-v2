...
description: 'A desktop YouTube video summarizer. Paste a link, get a structured summary with timestamps. Built with Tauri 2, Next.js, Rust, and Claude AI.'
...
I wanted a desktop app with a small footprint. While exploring Tauri and Electron, Tauri was the clear winner. The macOS `.dmg` comes in at ~6MB, the Windows installer at ~3MB. A bare Electron app ships at 150MB+ — roughly 25x the size. Learning Rust along the way was a bonus.
