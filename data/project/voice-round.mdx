...
- **15 topics across 4 tracks.**
  - _Languages_ — JS/TS, Python, Go, Java, Rust
  - _Frameworks_ — React/Next, Node, FastAPI/Django
  - _Concepts_ — system design (frontend, backend, full-stack), Docker/K8s, AWS, GraphQL
  - _Behavioral_ — STAR-format questions
...
Three architectural decisions, one und**MediaRecorder**erlying belief: **your interview practice is nobody's business but yours.**
